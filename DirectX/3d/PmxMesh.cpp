...
void PmxMesh::SetName(const std::string& name)
{
	this->name = name;
}

void PmxMesh::AddVertex(const VertexPosNormalUv& vertex)
{
	vertices.emplace_back(vertex);
}

void PmxMesh::AddIndex(unsigned short index)
{
	indices.emplace_back(index);
}

void PmxMesh::SetMaterial(Material* material)
{
